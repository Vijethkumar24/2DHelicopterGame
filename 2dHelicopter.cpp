...
void display(void)
{
	...
	glColor3f(1.0,1.0,1.0);
	renderBitmapString(30,85,0,GLUT_BITMAP_HELVETICA_18,"AJ Institute Of Engineering & Technology ");

	renderBitmapString(48,80,0,GLUT_BITMAP_HELVETICA_12,"Mangalore");

	glColor3f(1.0,1.0,0.0);
	renderBitmapString(20,65,0,GLUT_BITMAP_8_BY_13,"A mini project for Computer Graphics & Visualization Laboratory");
	renderBitmapString(45.5,70,0,GLUT_BITMAP_TIMES_ROMAN_24,"Helicopter");

	glColor3f(1.0,0.0,0.0);
	renderBitmapString(45,45,0,GLUT_BITMAP_TIMES_ROMAN_24,"Welcome");
	renderBitmapString(58,45,0,GLUT_BITMAP_TIMES_ROMAN_24,name);
	renderBitmapString(45.5,30,0,GLUT_BITMAP_TIMES_ROMAN_24,"Click To Start");
	...
	else
	{
		...
		scf+=0.25;              //so less as program run very fast
		sci=(int)scf;
		sprintf(scs,"%d",sci);
